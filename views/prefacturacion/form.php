            ...
            <div class="card-body pt-0 space-between">
                ...
                <div class="row g-3">
                    <div class="col-12 col-md-8 text-left">
                        ...
                        <select id="usuarioId" name="usuarioId" class="select-data custom-select data form-control selectpicker" data-live-search="true" hs-list-entity="Administrador" hs-list-field="Usuario.nombre" hs-list-value="Usuario.id"></select>
                    </div>                   
                </div>
