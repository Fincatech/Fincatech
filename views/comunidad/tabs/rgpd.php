<div class="tab-pane fade h-100 tabRGPD" id="rgpd" role="tabpanel">
    ...
    <div class="row h-100">
        ...
        <div class="col-12 d-flex">
            ...
            <div class="card flex-fill shadow-neumorphic pl-3 pb-3 pt-2 pr-3 card-principal">
                ...
                <div class="card-body shadow-inset rounded-lg border mb-1 d-flex">
                    ...
                    <div class="row flex-grow-1 pl-2 pr-2">
                        ...
                        <div class="col-12 space-between">
                            ...
                            <div class="row flex-grow-1 border border-top-0 shadow-neumorphic">
                                <div class="col-12 d-flex">
                                    <div class="tab-content d-flex row w-100">
                                        <?php include_once('documentacionbasica.php'); ?>
                                        <?php include_once('notasinformativas.php'); ?>
                                        <?php include_once('informesevaluacionseguimiento.php'); ?>
