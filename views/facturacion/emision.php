    ...
    <div class="col-12 d-flex position-relative">
        ...
        <div class="card flex-fill pl-3 pb-3 pt-2 pr-3 card-principal">
            ...
            <div class="card-header">
                ...
                <h5 class="card-title mb-0"><span class="titulo titulo-modulo pl-0"><i class="bi bi-receipt pr-2"></i> Emisión de Facturas</span></h5>
                    ...
                    <div class="col-12 col-lg-8">
                        ...
                        <div class="form-group row mb-2">
                            ...
                            <div class="col-12 col-lg-3">
                                <?php $App->RenderView('facturacion/partials/emision/mes_facturacion'); ?>
                            </div>                              
