    ...
    <div class="col-12 d-flex">
        ...
        <div class="card flex-fill shadow-neumorphic p-3">
            ...
            <div class="card-header pl-0">
                ...
                <h5 class="card-title mb-0"><i data-feather="<?php echo $iconoAccion; ?>"></i> <span class="titulo">Administrador de fincas</span></h5>
                ...
                <form class="form-data form-floating" autocomplete="off">
                    ...
                    <div class="form-group row mb-2">
                        ...
                        <!-- <div class="col-12 col-md-2">
                            <label for="password"><i class="bi bi-key pr-2"></i>Contraseña</label>              
                        ...
                        <div class="col-12 col-md-2">
                            <label for="passwordConfirme"><i class="bi bi-key pr-2"></i>Repetir contraseña</label>              
                        ...
                        <div class="col-12 col-md-2">
                            <label for="rolid"><i class="bi bi-key pr-2"></i>ROL / Tipo</label>              
                    ...
                    <div class="form-group row mb-2">
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control data" id="nombre" name="nombre" placeholder="Jorge Rodríguez" hs-entity="Usuario" hs-field="nombre" aria-label="nombre" aria-describedby="addon-nombre" required>
                        </div>
                    </div>
                    <!-- dirección -->
                    <div class="form-group row mb-2">
