                    ...
                    <div class="col-12 col-lg-8">
                        ...
                        <div class="form-group row mb-2">
                            ...
                            <div class="col-12 col-lg-2">
                                <label for="datefrom" class="pl-0 font-weight-bold"><i class="bi bi-calendar pr-2"></i>Desde</label>
                                <input type="date" class="form-control" id="datefrom" name="datefrom" />
                            </div>                              

                            <!-- Fecha hasta -->
                            <div class="col-12 col-lg-2">
                                <label for="dateto" class="pl-0 font-weight-bold"><i class="bi bi-calendar pr-2"></i>Hasta</label>
                    ...
                    <div class="col-12 col-lg-4">
                        <div class="row h-100">
                            <div class="col-12 br-10 p-3 d-flex flex-column" style="background:#f7f7fc;">
                                <?php $App->RenderView('liquidaciones/partials/generacion_info'); ?>
                            </div>
                        </div>    
                    </div>
