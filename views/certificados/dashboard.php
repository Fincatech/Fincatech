                    ...
                    <div class="col-12 rounded-lg mb-4">
                        <div class="card mb-1 shadow-neumorphic bg-white p-2">
                            <div class="list-group list-group-horizontal list-group-flush" role="tablist">
                                ...
                                <a class="list-group-item list-group-item-action" data-toggle="list" href="#contrato" role="tab" aria-selected="false"><i class="bi bi-file-earmark-check mr-2"></i> SMS Firma contrato</a>
                            </div>
                        </div>
                    </div>
