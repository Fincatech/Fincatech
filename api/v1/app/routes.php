...
return function (App $app) {
     ...
     * Stats de DPD
     */
    $app->get('/stats/dpd', function(Request $request, Response $response, array $params ): Response
    {
        ...
        $frontController = new $frontControllerName();
        $frontController->Init('Stats');

        $response->getBody()->write( HelperController::successResponse($frontController->context->DPD() ));
